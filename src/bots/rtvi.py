from src.bots.rtvi_actions import register_rtvi_actions
from src.bots.rtvi_services import register_rtvi_services
from src.bots.types import BotConfig
...
async def create_rtvi_processor(
    ...
    # Attach observer to rtvi
    # RTVIObserver(rtvi)  # This will handle all RTVI protocol messages
